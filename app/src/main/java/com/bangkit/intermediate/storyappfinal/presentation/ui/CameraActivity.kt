...
import com.bangkit.intermediate.storyappfinal.databinding.ActivityCameraBinding
    ...
    private fun startCamera() {
        ...
        cameraProviderFuture.addListener({
            ...
            val preview = Preview.Builder()
                .build()
                .also {
                    it.setSurfaceProvider(binding.vfPreview.surfaceProvider)
                }
            ...
            try {
                ...
                Toast.makeText(this@CameraActivity, resources.getString(R.string.failed_launch_camera), Toast.LENGTH_SHORT).show()
            }
        }, ContextCompat.getMainExecutor(this))
    }
